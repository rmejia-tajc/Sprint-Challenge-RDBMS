...
1. Explain the difference between `RDBMS` and `SQL`.
  ...
  - The Relational Database Mangement System is the software that manages the data. Structured Query Language is the language used to interact (query) with the RDBMS

1. Why do tables need a `primary key`?

  - To make their data unique for referencing purposes
...
1. What do we need in order to have a _many to many_ relationship between two tables.
  ...
  - Another table between the two original tables. This table will have a one to many relationship with each of the two original tables.
